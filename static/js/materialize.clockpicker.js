...
(function() {
    ...
    function ClockPicker(element, options) {
        ...
        if (value[0] === 'now') {
            ...
            submit = [leadingZero(now.getHours()), leadingZero(round15(now.getMinutes())), '00'];
            input.prop({
                default: submit.join(':')
            }).data({
                default: submit.join(':'),
